...
/*
 * HoloLensInputModule을 쓰면 제대로 될떄도 있고 안될때고 있다
 * 근데 코드가 없어서 디버깅이 불가능하니 야매로 구현
 * GearVR 시절에 쓰던 LookInputModule 기반
 * https://forums.oculus.com/developer/discussion/16710/new-unity-ui-ovr-look-based-input-howto
 */
...
namespace Assets.Mihiro.Scripts {
    class MyHoloLensInputModule : BaseInputModule, HoloToolkit.Unity.InputModule.IInputHandler {
        ...
        private static MyHoloLensInputModule _singleton;
        public static MyHoloLensInputModule singleton
        {
            get
            {
                return _singleton;
        ...
        private PointerEventData GetLookPointerEventData() {
            ...
            // screen center
            lookPosition.x = w * 0.5f;
            lookPosition.y = h * 0.5f;
